...
// PROPÓSITO: Gestión de Stock de Materia Prima.
// ─────────────────────────────────────────────────────────────────────────────
...
const InventarioPage = () => {
  ...
  const fetchData = async () => {
    ...
    setError(null);
    try {
      const bruto = await inventarioService.getAllBruto();
      setItemsBruto(bruto);
    } catch (err: any) {
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Gestión de productos tal como se compran al proveedor</p>
          </div>
        </div>
